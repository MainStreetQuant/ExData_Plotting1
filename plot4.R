...
# Step 5: Plot 4-chart dashboard directly to PNG device
...
# Make dashboard 2 rows by 2 columns (square)

par(mfrow = c(2, 2)) 

# Upper Left Plot (a.k.a plot2 from earlier in the assignment with altered axis label)

plot(Day, Power, type="l", xlab="", ylab="Global Active Power")

# Upper Right Plot

plot(Day, Voltage, type="l", xlab="datetime", ylab="Voltage")

# Lower Left Plot (a.k.a plot3 from earlier in the assignment)
...
plot(Day, Reactive, type="l", xlab="datetime", ylab="Global_reactive_power")
